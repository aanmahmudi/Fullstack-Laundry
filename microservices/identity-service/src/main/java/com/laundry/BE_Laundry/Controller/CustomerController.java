...
public class CustomerController {
	...
	public ResponseEntity<CustomerSummaryDTO> getCustomerSummaryById(@PathVariable Long id) {
		return ResponseEntity.ok(customerService.getCustomerSummaryById(id));
	}

	@GetMapping("/summary/by-email")
	public ResponseEntity<CustomerSummaryDTO> getCustomerSummaryByEmail(@org.springframework.web.bind.annotation.RequestParam String email) {
		return ResponseEntity.ok(customerService.getCustomerSummaryByEmail(email));
	}
